...
++ explain the parameters of the STL implementation in statsmodels.tsa.seasonal
explicitly address the seasonal, period and robust parameters. Other parameters
can be left alone - the default values are typically good enough.
...
decompostion_df["season"] = stl_decomp.seasonal
