...
++ our goal is to perform the following steps (show as itemized list): - Date and time features - Lag features - Window features - Cyclical features - Removing missing values

The feature engineering will be performed using the library feature_engine The purpose is to encapsulate all the operations in one pipeline
