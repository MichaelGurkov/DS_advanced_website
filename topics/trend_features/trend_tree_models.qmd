...
```{python plot_decision_tree}

plot_pred(df = raw_df.copy(), pred_train = y_pred_train_decision_tree,
          pred_test = y_pred_test_decision_tree)
...
```{python decision_tree_pred_square}
...
decision_tree.fit(X_train_square, y_train)

y_pred_train_decision_tree_square = decision_tree.predict(X_train_square)

y_pred_test_decision_tree_square = decision_tree.predict(X_test_square)

```

```{python plot_line_reg_square}

plot_pred(df = raw_df.copy(), pred_train = y_pred_train_decision_tree_square,
          pred_test = y_pred_test_decision_tree_square)
...
```{python decision_tree_pred_qube}
...
decision_tree.fit(X_train_qb, y_train)

y_pred_train_decision_tree_qb = decision_tree.predict(X_train_qb)

y_pred_test_decision_tree_qb = decision_tree.predict(X_test_qb)

```

```{python plot_line_reg_qube}

plot_pred(df = raw_df.copy(), pred_train = y_pred_train_decision_tree_qb,
          pred_test = y_pred_test_decision_tree_qb)
...
```{python decision_tree_pred_qube_robust}

decision_tree = LinearRegression()

decision_tree.fit(X_train_robust, y_train_robust)

y_pred_train_decision_tree_qb_robust = decision_tree.predict(X_train_robust)

y_pred_test_decision_tree_qb_robust = decision_tree.predict(X_test_robust)

```

```{python plot_line_reg_qube_robust}

plot_pred(df = raw_df.copy(), pred_train = y_pred_train_decision_tree_qb_robust,
          pred_test = y_pred_test_decision_tree_qb_robust)
